...
public class CategoryManager implements ICategoryService {
    ...
    public Category get(int id) {
        return this.categoryRepo.findById(id).orElseThrow(() -> new NotFoundException(Msg.NOT_FOUND)); // null gelebilme durumu olduğu için orElseThrow
    }

    @Override
    public Page<Category> cursor(int page, int pageSize) {
        Pageable pageable = PageRequest.of(page,pageSize);
        return this.categoryRepo.findAll(pageable);  // findAll pagination işlemi yapar.
    }
